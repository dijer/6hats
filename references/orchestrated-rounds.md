...
| 10. Execution readiness | Test whether the emerging decision can be acted on | Post: Verifier | Owner, reversible step, deadline, and review trigger; unknown owner/deadline stay `TO CONFIRM` |
